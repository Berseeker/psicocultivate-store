  ...
  (function () {
    const calendarEl = document.getElementById('calendar'),
      ...
      calendarsColor = {
        ...
        ETC: 'info',
        terapia: 'success',
        taller_infancia: 'warning',
        taller_juventudes: 'danger',
        reunion: 'info',
      },
    ...
    function eventClick(info) {
      ...
      var invitados = JSON.parse(eventToUpdate.extendedProps.invitados);
      ...
      invitados.forEach(element => {
        invitados !== undefined
          ? eventGuests.val(element).trigger('change')
          : null;
      });
      ...
      eventToUpdate.extendedProps.description !== undefined
        ...
        : null;
      eventToUpdate.url !== undefined
        ? (eventUrl.value = eventToUpdate.url)
        : null;

      // // Call removeEvent function
      btnDeleteEvent.addEventListener('click', e => {
         //console.log('entro aqui',eventToUpdate.id);
    ...
    function fetchEvents(info, successCallback) {
      ...
      $.ajax({
          ...
          success: function (result) {
            ...
            let eventosx = result.filter(function(event){
              return calendars.includes(event.extendedProps.calendar.toLowerCase())
            });
            console.log(eventosx);
            successCallback(eventosx);
          },
    ...
    function addEvent(eventData) {
      ...
      console.log('creando eventos', eventData);
      var json = JSON.stringify(eventData);
      $.ajax({
          url: '/api/create-evento',
          type: 'POST',
          data: json,
