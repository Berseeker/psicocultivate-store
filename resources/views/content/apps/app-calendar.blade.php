      ...
      <div class="p-3">
        ...
        <div class="app-calendar-events-filter ms-3">
          ...
          @foreach ($filtros as $filtro)
            <div class="form-check {{ $filtro->color}}">
              <input class="form-check-input input-filter" type="checkbox" id="select-{{ $filtro->codigo }}" data-value="{{ $filtro->codigo }}" checked>
              <label class="form-check-label" for="select-{{ $filtro->codigo}}">{{ $filtro->nombre }}</label>
            </div>
          @endforeach
        </div>
      </div>
          ...
          <form class="event-form pt-0" id="eventForm" onsubmit="return false">
            ...
            <div class="mb-3">
              ...
              <select class="select2 select-event-label form-select" id="eventLabel" name="eventLabel">
                ...
                <option data-label="success" value="terapia">Terapia</option>
                <option data-label="warning" value="taller_infancia">Taller Infancias</option>
                <option data-label="danger" value="taller_juventudes">Taller Juventudes</option>
                <option data-label="info" value="reunion">Reunion</option>
              </select>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3 select2-primary">
              ...
              <select class="select2 select-event-guests form-select" id="eventGuests" name="eventGuests" multiple>
                ...
                <option data-avatar="11.png" value="Benjamin">Benjamin</option>
              </select>
            </div>
            <div class="mb-3">
