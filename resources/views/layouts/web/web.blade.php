...
<head>
    ...
    <!-- favicons Icons -->
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('/images/favicons/logo_180x180.svg') }}" />
    <link rel="icon" type="image/png" sizes="32x32" href="{{ asset('/images/favicons/logo_40x40.svg') }}" /> <!-- 32x32 -->
    <link rel="icon" type="image/png" sizes="16x16" href="{{ asset('/images/favicons/logo_40x40.svg') }}" /><!-- 16x16 -->
    ...
    <!-- template styles -->
    <link rel="stylesheet" href="{{ asset('css/web/bleach.css') }}" />
