                                                ...
                                                <div class="home-showcase__inner">
                                                    <div class="row">
                                                        <div class="col-lg-3">
                                                            <div class="home-showcase__item">
                                                                <div class="home-showcase__image">
                                                                    <img src="{{ asset('/images/home-showcase/home-showcase-1-1.jpg') }}"
                                                                        alt="">
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="home-showcase__item">
                                                                <div class="home-showcase__image">
                                                                    <img src="{{ asset('/images/home-showcase/home-showcase-1-2.jpg') }}"
                                                                        alt="">
                                                                    <div class="home-showcase__buttons">
                                                                        <a href="index2.html"
                                                                            class="thm-btn home-showcase__buttons__item">Multi
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="home-showcase__item">
                                                                <div class="home-showcase__image">
                                                                    <img src="{{ asset('/images/home-showcase/home-showcase-1-3.jpg') }}"
                                                                        alt="">
                                                                    <div class="home-showcase__buttons">
                                                                        <a href="index3.html"
                                                                            class="thm-btn home-showcase__buttons__item">Multi
                                                        ...
                                                        <div class="col-lg-3">
                                                            <div class="home-showcase__item">
                                                                <div class="home-showcase__image">
                                                                    <img src="{{ asset('/images/home-showcase/home-showcase-1-4.jpg') }}"
                                                                        alt="">
                                                                    <div class="home-showcase__buttons">
